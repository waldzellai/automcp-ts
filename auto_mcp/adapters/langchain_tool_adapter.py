...
class LangchainToolAdapter(BaseMCPAdapter):
    """Adapter for converting Langchain objects to MCP tools."""
    ...
    def add_to_mcp(
        ...
        """
        Add a Langchain tool instance to an MCP server as an async tool.
