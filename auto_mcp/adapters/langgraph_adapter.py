...
def create_langgraph_adapter(
    ...
    body_str = f"""async def langgraph_agent({params_str}):
    ...
    langgraph_agent_async = namespace["langgraph_agent"]

    # Add proper function metadata
    langgraph_agent_async.__name__ = name
    langgraph_agent_async.__doc__ = description

    return langgraph_agent_async
